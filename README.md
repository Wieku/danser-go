...
* `-mods=HDHR` - display the map with given mods. All mods besides Target Practice are supported (Perfect/SuddenDeath not fully yet, but they won't crash the app)
