...
func (pp *PPv2) computeAimValue() float64 {
	...
	aimValue *= 1.0 + approachRateFactor * (0.33 + 0.66 * math.Min(1, float64(pp.totalHits) / 1000))//* (0.33 + 0.66 * math.Min(1, float64(pp.totalHits) / 1000))//math.Min(approachRateFactor, approachRateFactor*(float64(pp.totalHits)/1000.0))
