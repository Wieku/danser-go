...
func (body *Body) DrawNormal(projection mgl32.Mat4, color mgl32.Vec4, prev mgl32.Vec4) {
	drawSlider(body.bodySprite, body.framebuffer.Texture(), color, prev, projection)
}
