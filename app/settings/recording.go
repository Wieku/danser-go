...
type recording struct {
	...
	FPS                 int                `label:"FPS (PLEASE READ TOOLTIP)" string:"true" min:"1" max:"10727" tooltip:"IMPORTANT: If you plan to have \"high fps\" video, use Motion Blur below instead of setting FPS to absurd numbers!!!"`
